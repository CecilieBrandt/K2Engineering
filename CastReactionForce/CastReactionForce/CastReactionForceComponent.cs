...
namespace CastReactionForce
{
    public class CastReactionForceComponent : GH_Component
    {
        ...
        public CastReactionForceComponent()
            : base("CastSupportGoal", "CSupport",
                "Cast the output of the simple support goal",
                "K2Struct", "Utility")
        {
        }
        ...
        {
            pManager.AddGenericParameter("SimpleSupportOutput", "O", "The output from the simple support goal", GH_ParamAccess.item);
        }

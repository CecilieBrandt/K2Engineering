    ...
    public class BarElementComponent : GH_Component
    {
        ...
        public class Bar : GoalObject
        {
            ...
            public override object Output(List<KangarooSolver.Particle> p)
            {
                ...
                var Data = new object[2] { new Line(p[PIndex[0]].Position, p[PIndex[1]].Position), ( factor * Weighting[0] * Move[0].Length) / area };     //Extended/contracted line element and its stress in [MPa]
                return Data;
            }

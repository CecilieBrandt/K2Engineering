...
namespace CastBendingStress
{
    public class CastBendingStressComponent : GH_Component
    {
        ...
        {
            pManager.AddIntegerParameter("PIndexBending", "PIndexB", "The particle index associated with the moment", GH_ParamAccess.item);
            pManager.AddPlaneParameter("Plane", "plane", "The bending plane", GH_ParamAccess.item);
            pManager.AddNumberParameter("BendingStress", "stressB", "The bending stress value in the rod", GH_ParamAccess.item);
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            double stress = (double) output[2];

            //Output
            DA.SetData(0, PIndex);
            DA.SetData(1, pl);
            DA.SetData(2, Math.Round(stress,1));
        }
